...
$app->route("GET @admin:				/admin/index",		"Controller\AdminApp->index");
...
$app->route("GET @admin_courses: 	/admin/courses",	function($f3) {
	...
	$admin->set(new \Controller\Courses);
	$admin->courses->index($f3);
});

$app->route("GET @admin_courses_add: 	/admin/courses",	function($f3) {
	$admin = new \Base\Admin($f3);
	$admin->set(new \Controller\Courses);
	$admin->courses->index($f3);
});
...
$app->route("GET @course_update: /admin/student/update/@field/@value/@id", "Controller\Students->update");
